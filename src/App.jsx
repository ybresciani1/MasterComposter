...
const CrowSprite = () => (
  <svg viewBox="0 0 32 20" className="w-full h-full drop-shadow-lg" shapeRendering="crispEdges">
    ...
    <path d="M9,8 h11 v1 h-11z M8,9 h12 v1 h-12z M7,10 h13 v1 h-13z M8,11 h12 v1 h-12z M9,12 h11 v1 h-11z M20,8 h5 v1 h-5z M20,9 h6 v1 h-6z M20,10 h6 v1 h-6z M20,11 h6 v1 h-6z M20,12 h5 v1 h-5z" fill="#0c0e14" />
    <path d="M16,8 h3 v1 h-3z M17,9 h3 v1 h-3z M17,10 h3 v1 h-3z M17,11 h3 v1 h-3z M16,12 h3 v1 h-3z M23,8 h2 v1 h-2z M23,9 h3 v1 h-3z M23,10 h3 v1 h-3z M23,11 h3 v1 h-3z M23,12 h2 v1 h-2z" fill="#1a3040" />
